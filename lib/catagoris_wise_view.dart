...
class Kosaricapocetna_kategorije_Details extends StatefulWidget {
  final String catagories_name;
  const Kosaricapocetna_kategorije_Details(
      {super.key, required this.catagories_name});

  @override
  State<Kosaricapocetna_kategorije_Details> createState() =>
      _Kosaricapocetna_kategorije_DetailsState();
}

class _Kosaricapocetna_kategorije_DetailsState
    extends State<Kosaricapocetna_kategorije_Details> {
  ...
  Widget build(BuildContext context) {
    List<Offers>? filteredOffers = controller.filterOffersByCategory(
        controller.getAppDetails?.offers,
        controller.getAppDetails?.categories,
        "${widget.catagories_name}");
          ...
          child: Column(
            children: [
              filteredOffers != null
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                                '${controller.getAppDetails?.offers?[index].offerNewPriceEur.toString().substring(2, 4)}',
                  ...
                  : Center(
                      child: Text(
                        'No offers available for this store.',
...
// cartSheet(String storename,String storeimage,String offerimage,String offerdes, String offerPE,String offerPK ,String offerPEpoints,String offerPKPoints ,String valuedto, BuildContext context) {
//   showMaterialModalBottomSheet(
//     context: context,
//     builder: (BuildContext context) => StatefulBuilder(
//         builder: (BuildContext context, StateSetter setState) {
